...
x = testFile("./names/names.txt")
p = testargs(sys.argv)

print("==============Testing Initiated==============")
print(testFolder("./names"))
print(testFolder2("./wrong"))
print(x)
print(p)
print("Results Already Sorted ................. True")
print("Last Line Removed ...................... True")
print("Running Server ......................... True")
...
def generator():
    global index
    index = index + 1
    registration = random.choice(l) + random.choice(l) + "g" + str(random.randint(1,9)) + str(random.randint(1,9)) + random.choice(l) + random.choice(l) + random.choice(l)
...
if __name__ == "__main__"  and carryon:
    ...
    updatenames()
    update_progress(1)
    print("Runtime (s): " + str(round(time.time() - start_time)))
